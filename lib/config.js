...
export const SERVO_MIN_POS = 10_000;
export const SERVO_MAX_POS = 17_000;
...
export const PEN_DOWN_SPEED = 150;
// Travel speed when the pen is up; in mm/s
export const PEN_UP_SPEED = 150;
...
export const MIN_MOTION_SPEED = 5;
// Acceleration used for motion planning; in mm/s ^ 2
export const MOTION_ACCELERATION = 1000;
...
export const INVERT_X_AXIS = true;
